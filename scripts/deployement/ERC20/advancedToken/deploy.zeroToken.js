...
const tokenInfoPath = "scripts/deployement/ERC20/advancedToken/advancedTokenInfo.json";

async function deployMyToken(tokenInfo) {
  const { name, symbol, decimals, initialSupply } = tokenInfo;
  console.log("Deploying with arguments:", { name, symbol, decimals, initialSupply });
  console.log("Initial Supply Type:", typeof initialSupply);
